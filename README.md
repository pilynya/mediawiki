...
логинимся под пользователем wiki и паролем WikiP@ssw0rd <br/>
нажимаем править и удаляем весь текст с заглавной страницы, пишем что угодно и сохраняем изменения <br/>
